                        ...
                        <tbody>
                            <c:forEach var="p" items="${productos}">
                                <tr class="text-center">
                                    ...
                                    <td>${p.getStock()}</td>
                                    <td class="d-flex">
                                        <a href="Controlador?accion=EditarProducto&id=${p.id}" class="btn btn-warning">Editar</a>
                                        <a href="Controlador?accion=EliminarProducto&id=${p.id}" class="btn btn-danger">Eliminar</a>
                                    </td>
                                </tr>
                            </c:forEach>                           
                        </tbody>
