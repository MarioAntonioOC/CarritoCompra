...
//                p.setFoto(rs.getBinaryStream(3));
    ...
    try {
        ...
        ps.setInt(6, producto.getId()); // Usamos el ID para identificar el producto a actualizar
        
        int rowsUpdated = ps.executeUpdate();
        return rowsUpdated > 0; // Retorna true si al menos una fila fue actualizada
    } catch (Exception e) {
        e.printStackTrace(); // Manejo adecuado de excepciones, imprime detalles del error
        return false;
    }
}
